...
Algoritam grananja sa odsecanjem testiran je na malom skupu instanci
...
na malom skupu test instanci $IPG_{\gamma=0.2}$. 
Kolone redom označavaju: 
\begin{enumerate}
...
\begin{tabular}{ |P{0.5cm}|P{0.5cm}|P{0.5cm}||P{1cm}|P{0.7cm}|P{1cm}|P{1cm}| }
  ...
  \hline
 \end{tabular}
 \caption{Rezultati grananja sa odsecanjem na test instancama $IPG_{\gamma=0.2}$}
 \label{tbl:gso}
\end{table}
S obzrom na dužinu izvršavanja algoritma na instancama $m=\{16,32\}\times|gg|=\{20,24,28\}$
rezultati nisu prikazani već je tabela skraćena. Vreme izvršavanja je duže od 3 sata.

\begin{table}[H]
  \centering
  \begin{tabular}{ |P{0.5cm}|P{0.5cm}|P{0.5cm}||P{1cm}|P{0.7cm}|P{1cm}|P{1cm}| }
    \hline
    \multicolumn{7}{|c|}{$IP_{\gamma=0.1}$} \\
    \hline
