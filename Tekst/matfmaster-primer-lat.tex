...
hardverska i softverska specifikacija kao i specifičnosti implementacije.
...
za testiranje algoritma pretrage bima, ali kao što će biti pokazano u sekciji ref
...
Sada ćemo definisati skup instanci problema $IP$ koji je korišćen u sekciji ref.
Postoje četiri bitna parametra na osnovu kojih generišemo instance PNZN:
\begin{enumerate}
...
U ovoj sekciji će biti dat kratak pregled konfiguracije
računara na kome se vršilo testiranje kao i specifičnosti implementacije algoritama.
